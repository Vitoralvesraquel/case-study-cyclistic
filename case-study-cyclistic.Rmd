...
```
There are no electric bikes missing, this can be due to some tracking device 
included only on this model.
...
Trip duration values higher than one day will be disconsidered from now on.
