...
Create columns for trip duration, month_year, day, weekday, and start hour as 
integer.
...
discarding. Duration values longer than one day are considered as lost or stolen 
bikes, according to 
https://help.divvybikes.com/hc/en-us/articles/360033484791-What-if-I-keep-a-bike-out-too-long-, 
and will remain in the dataset for further analysis.
...
```{r}
rm(df, sum_rows_list, only_end, only_start, unique_start_station, 
   unique_end_station)
```
